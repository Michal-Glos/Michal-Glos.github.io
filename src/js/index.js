...
console.log("Hi I'm Michal - nice to meet you 😊")
...
fetch('https://api.github.com/users/michal-glos/repos?sort=created&direction=asc')
    ...
    <div class="project__content">
      <img src="/img/GithubWhite.svg" alt="">
    <h3 class="project__title project__grid"><span class="project__label">project:</span><span>${name}</span></h3>
